...
function exp_Location_4rule0_eval_expression(context) {
    // "Migration type" = 'Normal movement'

    var feature = context.feature;
    
    if (feature.properties) {
        return (feature.get('Migration type')  == 'Normal movement');
    } else {
        return (feature.get('Migration type')  == 'Normal movement');
    }
}
...
function exp_Location_4rule1_eval_expression(context) {
    // "Migration type" = 'Post-breeding migration'

    var feature = context.feature;
    
    if (feature.properties) {
        return (feature.get('Migration type')  == 'Post-breeding migration');
    } else {
        return (feature.get('Migration type')  == 'Post-breeding migration');
    }
}
...
function exp_Location_4rule2_eval_expression(context) {
    // "Migration type" = 'Pre-breeding migration'

    var feature = context.feature;
    
    if (feature.properties) {
        return (feature.get('Migration type')  == 'Pre-breeding migration');
    } else {
        return (feature.get('Migration type')  == 'Pre-breeding migration');
    }
}
...
function exp_Location_6rule0_eval_expression(context) {
    // "Migration type" = 'Normal movement'
...
function exp_Location_6rule1_eval_expression(context) {
    // "Migration type" = 'Post-breeding migration'
...
function exp_Location_6rule2_eval_expression(context) {
    // "Migration type" = 'Pre-breeding migration'
